...
import com.algawork.osworks.api.model.ComentarioInput;
import com.algawork.osworks.api.model.ComentarioModel;
...
public class ComentarioController {
	...
	public List<ComentarioModel> listar(@PathVariable Long ordemServicoId) {
		OrdemServico ordensServico = ordemServicoRepository.findById(ordemServicoId)
				.orElseThrow(() -> new EntidadeNaoEncontradaException("Ordem de Serviço não encontrada"));
		
		return toCollectionModel(ordensServico.getComentarios());
	}
